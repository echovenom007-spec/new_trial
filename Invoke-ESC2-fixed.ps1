...
.DESCRIPTION
    ...
    as -Attrib at submit time for non-domain-joined machines over VPN.
#>
...
# ============================================================================
$CAConfig     = "ILTLVNT151.ness.com\Ness IL CA SHA256"
$TemplateName = "Machine"
$DCTarget     = "192.168.1.10"
# ============================================================================
...
if ((-not $ekus) -or ($ekus -contains $anyPurposeOID)) {
